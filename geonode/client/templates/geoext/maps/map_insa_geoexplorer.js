...
<script type="text/javascript" src="{% static "geonode/js/extjs/GeoNode-Insa-GeoExplorer-Data.js" %}"></script>
<script type="text/javascript" src="{% static "geonode/js/extjs/GeoNode-Insa-GeoExplorer.js" %}"></script>
