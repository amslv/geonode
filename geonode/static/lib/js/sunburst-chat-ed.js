(function (global, factory) {
  ...
  var named = {
    level_one_desertif_color: 0xdddddd,
    level_two_color: 0xf9a86f,
    level_three_estado_color: 0xf58635,
    level_three_forca_motriz_color: 0xee3163,
    level_three_pressao_color: 0xffde8a,
    level_three_impacto_color: 0xae3336,
    level_three_resposta_color: 0xc28c5f,    
    level_four_condicao_terra_color: 0xfdd1a1,    
    level_four_influencia_social_campo_color: 0xed3237,
    level_four_desmatamento_color: 0xc28c55,
  ...
  var sunburst = Kapsule({
    ...
    update: function update(state) {
      ...
      label.append('textPath').attr('class', 'text-contour').attr('startOffset', '50%').attr('xlink:href', function (d) {
        if (focusD.data.name === d.data.name) {
          $(this).addClass(CSS_CLASSNAME_HIGHLIGHT_TEXT_CONTOUR);
        } 
        return '#hidden-arc-' + state.chartId + '-' + d.id;
      });
