...
GENERIC_UPLOAD_ERROR = _("Houve um erro enquanto tentávamos fazer upload dos seus dados. \
...
_PERMISSION_MSG_DELETE = _("Você não tem permissão para deletar essa camada.")
_PERMISSION_MSG_GENERIC = _('Você não tem permissões para essa camada.')
_PERMISSION_MSG_MODIFY = _("Você não tem permissão para modificar essa camada.")
_PERMISSION_MSG_METADATA = _(
    "Você não tem permissão para alterar os metadados dessa camada.")
_PERMISSION_MSG_VIEW = _("Você não tem permissão para visualizar essa camada.")
